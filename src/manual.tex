...
around a molecule. The field can be improved by assigning point-charges,
dipoles, quadrapoles, and polarizabilities to the atoms. These force fields
are more computationally expensive than standard point-charge force fields,
however, the results can be much more accurate.
