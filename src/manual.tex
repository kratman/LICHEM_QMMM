...
Electrostatics: $<$Charges or AMOEBA or GauPoles or Density$>$ \\

Diffuse charge calculations (GauPoles) require some additional information.
The GauPoles option expands the monopoles into spherical diffuse charges
within a cutoff radius.
This option serves as a correction to the MM force field. \\

Subpotential: $<$Charges or AMOEBA$>$  \\
GP\_atoms: $<$All$>$ \\
GP\_cutoff: $<$ Cutoff for the correction (\AA)$>$
...
Subpotential: $<$Charges or AMOEBA$>$  \\
GP\_atoms: $<$All or QMMM$>$ \\
GP\_cutoff: $<$ Cutoff for the correction (\AA)$>$ \\

The "QMMM" option in GauPoles only performs the correction for QM-MM
interactions. 
