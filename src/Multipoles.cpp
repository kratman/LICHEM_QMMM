  ...
  if (AMOEBA and PSI4)
  {
    ...
    for (int i=0;i<Natoms;i++)
    {
      if (Struct[i].MMregion)
      {
        ...
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].q1,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].x1,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].y1,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].z1,16);
        ofile << ")" << '\n';
        ofile << "Chrgfield.extern.addCharge(";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].q2,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].x2,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].y2,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].z2,16);
        ofile << ")" << '\n';
        ofile << "Chrgfield.extern.addCharge(";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].q3,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].x3,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].y3,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].z3,16);
        ofile << ")" << '\n';
        ofile << "Chrgfield.extern.addCharge(";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].q4,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].x4,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].y4,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].z4,16);
        ofile << ")" << '\n';
        ofile << "Chrgfield.extern.addCharge(";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].q5,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].x5,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].y5,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].z5,16);
        ofile << ")" << '\n';
        ofile << "Chrgfield.extern.addCharge(";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].q6,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].x6,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].y6,16) << ",";
        ofile << LICHEMFormDouble(Struct[i].PC[Bead].z6,16);
        ofile << ")" << '\n';
      }
    }
    ofile.flush();
